...
export function Header() {
  ...
  const links: [string, string, boolean][] = [
    ...
    // Link de compra oculto enquanto as vendas estão desativadas
    ...(SALES_ENABLED ? [[t('nav.buy'), '/events', false] as [string, string, boolean]] : []),
  ...
  return (
    ...
    >
      <div className="max-w-[1480px] mx-auto px-5 md:px-8 h-[68px] flex items-center gap-4 whitespace-nowrap">
        ...
        {/* Comprar CTA — oculto enquanto as vendas estão desativadas */}
        {SALES_ENABLED && (
          <Link
            to="/events"
